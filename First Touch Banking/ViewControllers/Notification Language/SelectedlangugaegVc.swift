...
class SelectedlangugaegVc: BaseVC {
    ...
    @IBAction func radioButton1(_ sender: UIButton) {
        ...
        radioButton1.setBackgroundImage(UIImage(named: "checkmark"), for: .normal)
        
        //        radioButton1.setImage(UIImage(named: "checkmark"), for: .normal)
        
        //        radiobutton2.setBackgroundImage(UIImage(named: "checkUncheckedmark"), for: .normal)
        radiobutton2.setImage(UIImage(named: "checkmark"), for: .normal)
        //        api calling
    ...
    @IBAction func radiobutton2(_ sender: UIButton) {
        radiobutton2.setBackgroundImage(UIImage(named: "checkmark"), for: .normal)
        radioButton1.setBackgroundImage(UIImage(named: "checkUncheckedmark"), for: .normal)
        //        api calling
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.5) {
